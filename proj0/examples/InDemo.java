...
public class InDemo {
	...
	public static void main(String[] args) {
		...
		while (!in.isEmpty()) {
			/*
			 * Each line has the rank of a country, then its name, then its production in
			 * metric tons, and finally the fraction of world salt output it produces.
			 */
			i += 1;
			...
			if (name.equals(args[0])) {
				System.out.println(args[0] + " produces " + tons + " of salt per year. Very nice!");
			}
		}
	}
}